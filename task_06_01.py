...
#
# (Справочно: Не учтенный при оценке функций объем памяти выденной для констант 108)
#
# Резултаты замера на матрице 500 х 500:
#
#   функция m_for_in объем выделнной памяти под переменные 9 170 456
#   функция m_while объем выделнной памяти под переменные 9 134 700
#   функция m_min_max объем выделнной памяти под переменные 17 886 828
#
# (Справочно: Не учтенный при оценке функций объем памяти выденной для констант 108)
#
# По результатм проведенного анализа сделан вывод, что с точки зрения минимального выделения памяти наиболее
# оптимальный алгорим в функции m_while и m_for_in
...
# Переменная MIN_ITEM        Тип переменной = <class 'int'>, Выделено памяти = 24
# Переменная MAX_ITEM        Тип переменной = <class 'int'>, Выделено памяти = 28
# Переменная array_static    Тип переменной = <class 'list'>, Выделено памяти = 9135336
# Всего выделено памяти = 9135444
...
# ************************ 500x500 *************************
# Наименование функции: m_for_in
# Переменная matrix          Тип переменной = <class 'list'>, Выделено памяти = 9134592
# Переменная min_column      Тип переменной = <class 'list'>, Выделено памяти = 17520
# Переменная line            Тип переменной = <class 'list'>, Выделено памяти = 18264
# Переменная j               Тип переменной = <class 'int'>, Выделено памяти = 28
# Переменная el              Тип переменной = <class 'int'>, Выделено памяти = 24
# Переменная max_el          Тип переменной = <class 'int'>, Выделено памяти = 28
# Всего выделено памяти = 9170456
...
# Переменная max_el          Тип переменной = <class 'int'>, Выделено памяти = 28
# Переменная j               Тип переменной = <class 'int'>, Выделено памяти = 28
# Переменная min_el          Тип переменной = <class 'int'>, Выделено памяти = 24
# Переменная i               Тип переменной = <class 'int'>, Выделено памяти = 28
# Всего выделено памяти = 9134700
...
# Наименование функции: m_min_max
# Переменная matrix          Тип переменной = <class 'list'>, Выделено памяти = 9134592
# Переменная min_el          Тип переменной = <class 'list'>, Выделено памяти = 8733944
# Переменная i               Тип переменной = <class 'int'>, Выделено памяти = 28
# Переменная line            Тип переменной = <class 'list'>, Выделено памяти = 18264
# Всего выделено памяти = 17886828
